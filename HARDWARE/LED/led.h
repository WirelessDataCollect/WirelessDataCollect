...
#define LED3_CONV()  (LED3=~LED3) //取反
#define LED4         PCout(1)	// LED2	
#define LED4_OFF(x)  LED4=x //是否关闭LED2
#define LED4_CONV()  (LED4=~LED4) //取反
...
#define DIGITAL_INPUT1 (~GPIO_ReadInputDataBit(DIG1_PORT,DIG1_PIN))//电路中会把高读取为0，低读取为1，故取反
