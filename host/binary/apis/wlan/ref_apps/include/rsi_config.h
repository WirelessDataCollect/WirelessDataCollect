...
#define RSI_PSK                   "12345678"// "1234567890"       //"518518518"                  //@ PSK.If we are using WPA2, this is the key, In open mode NULL
...
#define RSI_JOIN_SSID             "Song iPhone" //"mywifi5G"//"TP-LINK_5G_528"                  //@ SSID to join
