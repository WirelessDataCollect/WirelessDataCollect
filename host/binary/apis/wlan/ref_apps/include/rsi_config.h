...
#define RSI_PSK                    "518518518"//"1234567890"                          //@ PSK.If we are using WPA2, this is the key, In open mode NULL
...
#define RSI_JOIN_SSID              "TP-LINK_5G_528"//   "mywifi5G"               //@ SSID to join
