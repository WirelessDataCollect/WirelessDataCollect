...
#ifdef RSI_JOIN_SSID_MAX_LENGTH
    #define RSI_PSK_LEN                         RSI_JOIN_SSID_MAX_LENGTH     //@ maximum length of PSK    ，原来是64
#else
	#define RSI_PSK_LEN                         64     //@ maximum length of PSK    ，原来是64
#endif
#ifdef RSI_PSK_MAX_LENGTH
	#define RSI_SSID_LEN                        RSI_PSK_MAX_LENGTH     //@ maximum length of SSID
#else
...
typedef union {
  struct {
    ...
    uint8                    uSocketBuf[140];        //@ 24 bytes, byte format to send to spi
} rsi_uSocket;
...
{
    unsigned long       nx_ip_total_packet_send_requests;
    unsigned long       nx_ip_total_packets_sent;
    unsigned long       nx_ip_total_bytes_sent;
    unsigned long       nx_ip_total_packets_received;
    unsigned long       nx_ip_total_packets_delivered;
    unsigned long       nx_ip_total_bytes_received;
    unsigned long       nx_ip_packets_forwarded;
    unsigned long       nx_ip_packets_reassembled;
    unsigned long       nx_ip_reassembly_failures;
    unsigned long       nx_ip_invalid_packets;
    unsigned long       nx_ip_invalid_transmit_packets;
    unsigned long       nx_ip_invalid_receive_address;
    unsigned long       nx_ip_unknown_protocols_received;
    unsigned long       nx_ip_transmit_resource_errors;
    unsigned long       nx_ip_transmit_no_route_errors;
    unsigned long       nx_ip_receive_packets_dropped;
    unsigned long       nx_ip_receive_checksum_errors;
    unsigned long       nx_ip_send_packets_dropped;
    unsigned long       nx_ip_total_fragment_requests;
    unsigned long       nx_ip_successful_fragment_requests;
    unsigned long       nx_ip_fragment_failures;
    unsigned long       nx_ip_total_fragments_sent;
    unsigned long       nx_ip_total_fragments_received;

    unsigned long       nx_ip_arp_requests_sent;
    unsigned long       nx_ip_arp_requests_received;
    unsigned long       nx_ip_arp_responses_sent;
    unsigned long       nx_ip_arp_responses_received;
    unsigned long       nx_ip_arp_aged_entries;
    unsigned long       nx_ip_arp_invalid_messages;
    unsigned long       nx_ip_arp_static_entries;

    unsigned long       nx_ip_udp_packets_sent;
    unsigned long       nx_ip_udp_bytes_sent;
    unsigned long       nx_ip_udp_packets_received;
    unsigned long       nx_ip_udp_bytes_received;
    unsigned long       nx_ip_udp_invalid_packets;
    unsigned long       nx_ip_udp_no_port_for_delivery;
    unsigned long       nx_ip_udp_receive_packets_dropped;
    unsigned long       nx_ip_udp_checksum_errors;

    unsigned long       nx_ip_tcp_packets_sent;
    unsigned long       nx_ip_tcp_bytes_sent;
    unsigned long       nx_ip_tcp_packets_received;
    unsigned long       nx_ip_tcp_bytes_received;
    unsigned long       nx_ip_tcp_invalid_packets;
    unsigned long       nx_ip_tcp_receive_packets_dropped;
    unsigned long       nx_ip_tcp_checksum_errors;
    unsigned long       nx_ip_tcp_connections;
    unsigned long       nx_ip_tcp_passive_connections;
    unsigned long       nx_ip_tcp_active_connections;
    unsigned long       nx_ip_tcp_disconnections;
    unsigned long       nx_ip_tcp_connections_dropped;
    unsigned long       nx_ip_tcp_retransmit_packets;
    unsigned long       nx_ip_tcp_resets_received;
    unsigned long       nx_ip_tcp_resets_sent;

    unsigned long       nx_ip_icmp_total_messages_received;
    unsigned long       nx_ip_icmp_checksum_errors;
    unsigned long       nx_ip_icmp_invalid_packets;
    unsigned long       nx_ip_icmp_unhandled_messages;
    unsigned long       nx_ip_pings_sent;
    unsigned long       nx_ip_ping_timeouts;
    unsigned long       nx_ip_ping_threads_suspended;
    unsigned long       nx_ip_ping_responses_received;
    unsigned long       nx_ip_pings_received;
    unsigned long       nx_ip_pings_responded_to;

    unsigned long       nx_ip_igmp_invalid_packets;
    unsigned long       nx_ip_igmp_reports_sent;
    unsigned long       nx_ip_igmp_queries_received;
    unsigned long       nx_ip_igmp_checksum_errors;
    unsigned long       nx_ip_igmp_groups_joined;

    unsigned long       ip_icmp_total_messages_sent;
